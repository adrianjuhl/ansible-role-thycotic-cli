...
curl_thycotic_get_secret()
{
  ...
  curl --silent --write-out "%{stderr}%{http_code}" -H "Authorization: Bearer ${THYCOTIC_CLI_THYCOTIC_API_ACCESS_TOKEN}" -d @- --url "${THYCOTIC_CLI_THYCOTIC_HOST_URL}/v2/secrets/${THYCOTIC_CLI_SECRET_ID}"
}
